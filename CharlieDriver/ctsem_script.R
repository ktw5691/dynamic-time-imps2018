...
plotvar <- 'Y1'
plot(dat[dat[,'id']==1,'time'],dat[dat[,'id']==1,plotvar],type='l',ylim=range(dat[,plotvar],na.rm=TRUE))
...
#fit
f1 <- ctStanFit(datalong = dat, ctstanmodel = m1, cores = setcores,chains = setchains,plot=TRUE,
